...
//        String url = "https://www.youtube.com/watch?v=FzU-czBuDbo";
  ...
  public void testYouTubeListXPath() {
    ...
    Integer proxyPort = 8087;
    String url =
        "https://www.youtube.com/watch?v=myQ8htc4obg&list=PL6NNWaAj2a3KwGWKKfidyYgZcLZU_B2sC&index=1";
    Site site = new Site()
//            .setProxyIp(proxyIp).setProxyPort(proxyPort)
    ...
    List<Task> list = new YoutubeProcessor().getTasks(page, site, new YouTubeCrawler());
